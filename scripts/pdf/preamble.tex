...
% Optionales 1. Argument: Sprungmarke fuer @-Verweise (\hyperref[env-<id>]),
% z. B. \begin{fmmenv}[env-kkt]{fmmblue}{Satz}{12.5.7 (KKT)}. Handnummerierte
% Umgebungen lassen es weg und bekommen kein \label.
\newtcolorbox{fmmenv}[4][]{%
  ...
  before upper={\emergencystretch=3em
    ...
    \noindent\textbf{\sffamily\color{#2!75!black}#3~#4}\par\smallskip}%
}
