 ...
 * und ihr den Status nehmen (Bemerkung 11.1.8).
 *
 * Ersatz für convex-hull.png (Folien 11-konvexitaet, Z. 128–134). Die
 ...
 *
 * FARBROLLEN (Kapitel 11): konvexe Menge blau, Konvexkombination (der
