 ...
 * Ecke bleibt x̂ sogar stehen, während x weiterläuft (Satz 11.3.1, 11.3.3).
 *
 ...
 * projektionstheorem.pdf (11-konvexitaet.Rmd Z. 359 bzw. 383).
 *
 * FARBROLLEN (Kapitel 11): Menge blau, Projektion und Abstandsstrecke orange
