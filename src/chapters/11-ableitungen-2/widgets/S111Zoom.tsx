...
/**
 * §11.1: Die EINE Einsicht — differenzierbar heißt „lokal linear": Zoomen wir
 ...
 *
 * Farbrollen Kapitel 11 (= Kapitel 10): Funktion blau, Gerade (der lineare
 ...
 * (geprüft für h = 0,5, 0,01, 10⁻⁸), passend zu Beispiel 11.1.3.
...
export function ZoomWidget() {
  ...
  if (kurve.art === "glatt" || !imFenster) {
    ...
    verdikt =
      ...
      `nach Satz 11.1.2 dort auch stetig.`;
    ...
    verdikt =
      ...
      `Beispiel 11.1.3: Der Differenzenquotient strebt von rechts gegen +1 und von links gegen −1, ` +
      `und Definition 10.1.1 verlangt einen einzigen Wert. Stetig ist |x| in 0 trotzdem – die ` +
      `Umkehrung von Satz 11.1.2 gilt eben nicht.`;
