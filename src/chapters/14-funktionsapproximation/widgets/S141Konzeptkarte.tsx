...
export function TeilDreiKarte() {
  return (
    <ConceptFlow
      ariaLabel="Konzeptkarte von Teil 3: von Basen und Funktionenräumen über Interpolation und Splines zu Glättung, Bias-Varianz-Abwägung und Tensorprodukt-Splines."
      nodes={nodes}
      edges={edges}
      groups={[
