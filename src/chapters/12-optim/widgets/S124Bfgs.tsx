 ...
 * exakt (Satz 12.4.10); mit alpha = 1 dagegen geht der erste Schritt zu weit.
 *
 * BFGS-Stepper zur Folie „BFGS-Verfahren" (12-optim.Rmd Z. 760-770).
 *
 ...
 *    4,97e-16 (exakt).
 *
 * Farbrollen (Farbcode Kapitel 12): blau die Iterierten, orange Gradient und
