...
/**
 * §13.1 — DIE EINE EINSICHT: Newton verdoppelt in der Nähe einer einfachen
 ...
 *
 * Eigenbau zu Algorithmus 13.1.11 und Bemerkung 13.1.13; die Bauform (Kurve,
...
export function NewtonNullstelle() {
  ...
  if (Math.abs(dfx) < 1e-13) {
    ...
    text = `An dieser Stelle ist f′ = 0, die Tangente schneidet die x-Achse also nirgends, und Algorithmus 13.1.11 lässt sich nicht ausführen. Genau diese Voraussetzung steht dort in der Bedingung „solange f′(x⁽ᵏ⁾) ≠ 0".`;
