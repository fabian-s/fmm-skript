 ...
 * KKT-Bedingungen, eingefärbt nach dem Kapitel beziehungsweise der
 * Abschnittsgruppe, in der ein Begriff eingeführt wird. Steht am Anfang von Kapitel 10 als Vorschau: beim ersten Lesen
 * reicht der Gesamteindruck, am Ende von Kapitel 12 lohnt der zweite Blick.
 */
...
const nodes: FlowNode[] = [
  ...
  { id: "konvf", label: ["Konvexe Funktion"], x: 400, y: 314, w: 160, group: "k12", href: "?k=11-konvexitaet" },
  { id: "konvm", label: ["Konvexe Menge"], x: 640, y: 314, w: 150, group: "k12", href: "?k=11-konvexitaet" },
  {
    id: "newton",
  ...
  { id: "strikt", label: ["Strikte Konvexität"], x: 350, y: 412, w: 160, group: "k13", href: "?k=12-optim" },
  { id: "subgrad", label: ["Subgradient"], x: 580, y: 412, w: 130, group: "k13", href: "?k=12-optim" },
  { id: "stark", label: ["Starke Konvexität"], x: 350, y: 500, w: 160, group: "k13", href: "?k=12-optim" },
  { id: "kkt", label: ["Lagrange / KKT"], x: 610, y: 500, w: 150, group: "k13", href: "?k=12-optim" },
  {
    id: "gd",
  ...
  { id: "momsgd", label: ["Momentum & SGD"], x: 150, y: 690, w: 165, group: "k13", href: "?k=12-optim" },
];
