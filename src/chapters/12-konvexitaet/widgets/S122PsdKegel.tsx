...
/**
 * §12.2: Der Kegel der positiv semidefiniten 2x2-Matrizen (Eigenbau, neu).
 *
 ...
 * zwei Matrizen auch ihre Verbindungsstrecke (Satz 12.2.8).
 *
 ...
 *
 * FARBROLLEN (Kapitel 12): die konvexe Menge (Kegel, Schnitt, Randfläche)
    ...
    <div className="space-y-3">
      ...
      {art === "definit" ? (
        <Verdikt kind="ok" titel="Positiv definit.">
          ...
          semidefinit im Sinne von Definition 12.2.7. Der Punkt liegt im Inneren des blauen
        ...
        <Verdikt kind="warn" titel="Semidefinit, aber nicht definit: A liegt auf dem Rand.">
          ...
          das Cholesky-Verfahren scheitert (Bemerkung 12.2.9).
        </Verdikt>
      ) : art === "indefinit" ? (
        <Verdikt kind="fail" titel="Indefinit: A gehört nicht zu 𝒫₂.">
          ...
          aus Definition 12.2.7 ist verletzt. In der linken Tafel liegt der Punkt unter der
          Hyperbel: ac = {fmtDe(a * c)} ist kleiner als b² = {fmtDe(b * b)}. Der Kegel ist
          trotzdem konvex; Satz 12.2.8 verbietet nur, dass eine Mischung zweier semidefiniter
        ...
        <Verdikt kind="neutral" titel="Die Nullmatrix.">
          ...
          Definition 12.2.7 ist mit Gleichheit erfüllt, und A liegt in 𝒫₂, und zwar als Spitze
