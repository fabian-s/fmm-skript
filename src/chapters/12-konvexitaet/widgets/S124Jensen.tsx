 ...
 * genau die gewichtete Varianz der Stützstellen (Satz 12.4.6, Beispiel 12.4.8).
 *
 ...
 * beiden Seiten von (12.4.1) als zwei Markierungen über derselben Stelle
 * x̄ = Σ w_i x_i:
 *
 *   orange: f(x̄)            (Funktionswert der Mischung, auf der Kurve)
 *   grün:   Σ w_i f(x_i)    (Mischung der Funktionswerte, im Dreieck)
 *
 * FARBROLLEN (Kapitel 12): konvexe Funktion und ihr Epigraph blau,
 ...
 * (Beispiel 12.1.3): E[X] = 3,5, E[X²] = 15,1667, Varianz 35/12 = 2,9167.
 */
    ...
    <div className="space-y-3">
      ...
      {!definiert ? (
        <Verdikt kind="fail" titel="Summe null, keine Gewichte.">
          ...
          Satz 12.4.6 lässt sich so nicht erfüllen, und wir müssten durch null teilen. Wir
        ...
        <Verdikt kind="warn" titel="Gleichheit: das ganze Gewicht liegt auf einer Stützstelle.">
          ...
          (12.4.1) derselbe Wert {fmtDe(links)}, die Ungleichung ist mit Gleichheit erfüllt. Das
        ...
        <Verdikt kind="ok" titel="Jensen: der grüne Punkt liegt über dem orangen.">
          ...
          der Kurve, genau wie (12.4.1) es verlangt. Der grüne Punkt liegt im Dreieck der drei
          ...
          {fkt.key === "quad" && (
            <>
              ...
              Beispiel 12.1.3, wo E[X²] − E[X]² = 35/12 = {fmtDe(35 / 12)} herauskommt
              (Beispiel 12.4.8). Deshalb ist die Varianz nie negativ.
            </>
          )}
        </Verdikt>
      ) : (
        <Verdikt kind="fail" titel="Konkave Gegenprobe: die Ungleichung dreht sich um.">
          ...
          Satz 12.4.6, sondern seine Spiegelung (Bemerkung 12.3.9): −√x ist konvex, für diese
          Funktion gilt (12.4.1), und Multiplikation mit −1 dreht das Zeichen um.
        </Verdikt>
      )}
    </div>
  );
