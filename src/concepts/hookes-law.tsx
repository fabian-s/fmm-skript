  ...
  body: (
    <>
      <p>
        ...
        <M>{"F = k\\,x"}</M> &mdash; doppelte Dehnung, doppelte Kraft. Für
      ...
      <p>
        ...
        der <em>Elastizitätsmodul</em> (Young&apos;s modulus) &mdash; eine
      ...
      <p>
        ...
        gewissen Punkt &mdash; ziehen wir stark genug, verformt sich das
        Material dauerhaft &mdash; aber im elastischen Bereich ist die lineare
        Beschreibung ausgezeichnet. Genau das ist das wiederkehrende Muster:
