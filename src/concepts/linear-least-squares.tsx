...
import { ConceptLink, LabeledPlot, M, MD, registerConcept, Slider } from "../lib";
...
registerConcept({
  ...
  title: "Lineares Kleinste-Quadrate-Problem",
  body: (
    <>
      <p>
      ...
      <p>
        ...
        der Spalten von <M>{"\\bA"}</M>; die Daten selbst dürfen durch
        beliebige Funktionen eingehen. Eine Gerade{" "}
        <M>{"y \\approx x_1 + x_2 t"}</M> an die drei Punkte{" "}
        <M>{"(1,1), (2,2), (3,2)"}</M> anzupassen bedeutet
      </p>
      <MD>
