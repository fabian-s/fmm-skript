export const title = "Differentialgleichung";
...
Zahl ist, sondern eine ganze *Funktion*, und die diese
Funktion mit ihrer eigenen
:k[Ableitung]{#derivative} verknüpft. Ein
...
sehr oft ein *lineares* System. Das ist ein Grund, warum das
