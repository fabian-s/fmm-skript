...
registerConcept({
  id: "domain-codomain",
  title: "Definitionsbereich, Zielbereich & Bild",
  body: (
    <>
      <p>
        Der <em>Definitionsbereich</em> (domain) einer{" "}
        <ConceptLink id="function">Funktion</ConceptLink> ist die Menge der
        Eingaben, die sie akzeptiert; der <em>Zielbereich</em> (codomain) ist
        die Menge, in der ihre Ausgaben laut Deklaration leben. Schreiben wir
      </p>
      <MD>{"f: \\R^D \\to \\R"}</MD>
      <p>
        dann heißt das: Der Definitionsbereich ist <M>{"\\R^D"}</M> (alle{" "}
