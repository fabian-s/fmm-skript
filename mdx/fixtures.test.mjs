...
const NUM_ACCEPT = {
  ...
  "@num on section (kap/key form)": [`Abschnitte @num:optim/beschraenkt und @num:svd/motivation.`, `href="?k=06-svd#sec-6.1">{"6.1"}`],
  "@num on section same chapter": [`Abschnitte @num:optim/beschraenkt und …`, `href="#sec-12.5">{"12.5"}`],
  "@num on chapter": [`Kapitel @num:svd und @num:optim.`, `href="?k=06-svd">{"6"}`],
  "@ref on section": [`Siehe @ref:svd/motivation.`, `{"Abschnitt 6.1"}`],
  "@ref on chapter": [`Siehe @ref:svd.`, `{"Kapitel 6"}`],
